        ...
        The slope of the line will correspond to the spring constant $k_{exp}$.
			...
			\begin{center}
				\fbox{\begin{minipage}{22em}
								Using this graph, the spring constant $k_{exp} = 276.52 \frac{N}{m}$
							\end{minipage}}
			\end{center}

  \item Compare your experimental value(s) of $k_{exp}$ with the actual value(s) of $k$ for 
        your spring. (Spring k is 278 $\frac{N}{m}$)
				
			\begin{center}
				\fbox{\begin{minipage}{21em}
								The actual constant value of the spring is $278 \frac{N}{m}$.\\
								The experimental value of the spring is $276.52 \frac{N}{m}$.\\
								The difference between the two values is $1.48 \frac{N}{m}$.\\
							\end{minipage}}
			\end{center}
